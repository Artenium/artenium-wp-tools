...
- Les outils artenium fonctionnent avec l'extension [Redis Object Cache](https://wordpress.org/plugins/redis-cache) sur les serveurs artenium qui font tourner Varnish + Redis + OPCache.
